			...
			<table id="table">
				...
				<tr>
					...
					<td><input type="password" id="pw" name="pw" maxlength="16"
						pattern="[a-zA-z0-9!@#$%^&*]{4,12}" /> <font size="2px">8~16자리(영어(대소문자),
							숫자, 특수문자만 허용)</font></td>
				</tr>
				...
				<tr>
					...
					<td><input type="password" id="pw_check" name="pw_check"
						maxlength="16" pattern="[a-z0-9!@#$%^&*]{4,12}" /> <font
						size="2px">8~16자리(영어(대소문자), 숫자, 특수문자만 허용)</font> <!-- 비밀번호와 비밀번호 확인이 일치하지 않으면 경고문이 출력되고 맞게 입력했으면 경고문이 사라지거나
